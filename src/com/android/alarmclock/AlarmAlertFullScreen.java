...
/**
 * patalix clock alarm alert: pops visible indicator and plays alarm
...
public class AlarmAlertFullScreen extends Activity {
    ...
    private void updateLayout() {
        ...
        SharedPreferences settings =
                getSharedPreferences(patalixclock.PREFERENCES, 0);
        int face = settings.getInt(patalixclock.PREF_CLOCK_FACE, 0);
        if (face < 0 || face >= patalixclock.CLOCKS.length) {
            face = 0;
        }
        ViewGroup clockView = (ViewGroup) findViewById(R.id.clockView);
        inflater.inflate(patalixclock.CLOCKS[face], clockView);
