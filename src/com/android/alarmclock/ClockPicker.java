...
/**
 * Clock face picker for the patalix clock application.
 */
public class ClockPicker extends Activity implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        mPrefs = getSharedPreferences(patalixclock.PREFERENCES, 0);
        int face = mPrefs.getInt(patalixclock.PREF_CLOCK_FACE, 0);
        if (face < 0 || face >= patalixclock.CLOCKS.length) face = 0;
    ...
    public void onItemSelected(AdapterView parent, View v, int position, long id) {
        ...
        mClock = mFactory.inflate(patalixclock.CLOCKS[position], null);
    ...
    private synchronized void selectClock(int position) {
        ...
        ed.putInt(patalixclock.PREF_CLOCK_FACE, position);
        ed.commit();
    ...
    class ClockAdapter extends BaseAdapter {
        ...
        public int getCount() {
            return patalixclock.CLOCKS.length;
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            View clock = mFactory.inflate(patalixclock.CLOCKS[position], null);
            return clock;
        }
