...
/**
 * The Alarms provider supplies info about patalix clock settings
 */
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.android.patalixclock.ALARM_ALERT";
